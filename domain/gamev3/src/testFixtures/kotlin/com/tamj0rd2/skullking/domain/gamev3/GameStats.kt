...
object GameStats {
    fun PropertyContext.checkCoverageForAllGameStates() = apply {
        checkCoverageExists(
            "state",
            GameStateName.entries
                ...
                .filter {
                    when (it) {
                        // NOTE: put WIP states in here to help drive development without failing
                        // lots of tests.
                        else -> true
                    }
                }
    ...
    fun PropertyContext.collectCommand(command: GameCommand) =
