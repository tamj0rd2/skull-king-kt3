...
object PropertyTesting {
    ...
    @OptIn(ExperimentalKotest::class)
    val propTestConfig
        get() = PropTestConfig(iterations = 200, maxDiscardPercentage = 99)

    private val stackTracePartsToIgnore = setOf(PropertyTesting::class.qualifiedName!!, "io.kotest", "kotlin.coroutines", "kotlin.test")
    ...
    @OptIn(ExperimentalKotest::class)
    fun PropertyContext.checkCoverageExists(label: String? = null, expectedClassifications: Set<Any?>) = apply {
